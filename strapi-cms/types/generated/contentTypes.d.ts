...
export interface ApiMarketingTextMarketingText extends Schema.SingleType {
  collectionName: 'marketing_texts';
  info: {
    singularName: 'marketing-text';
    pluralName: 'marketing-texts';
    displayName: 'MarketingText';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::marketing-text.marketing-text',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::marketing-text.marketing-text': ApiMarketingTextMarketingText;
